...
func Orgs_revoke_org_role_teamHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_revoke_org_role_teamTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_organization-roles_teams_team_slug_role_id",
		mcp.WithDescription("Remove an organization role from a team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_revoke_org_role_teamHandler(cfg),
	}
}
