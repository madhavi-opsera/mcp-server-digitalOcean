...
func Api_insights_get_summary_stats_by_actorHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/insights/api/summary-stats/%s/%s%s", cfg.BaseURL, org, actor_type, actor_id, queryString)
		...
		var result models.GeneratedType_Api_insights_summary_stats
...
func CreateApi_insights_get_summary_stats_by_actorTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_insights_api_summary-stats_actor_type_id",
		mcp.WithDescription("Get summary stats by actor"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Api_insights_get_summary_stats_by_actorHandler(cfg),
	}
}
