...
func Orgs_list_custom_properties_values_for_reposHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["repository_query"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("repository_query=%v", val))
		}
		queryString := ""
		...
		var result []models.GeneratedType_Org_repo_custom_property_values
...
func CreateOrgs_list_custom_properties_values_for_reposTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_properties_values",
		mcp.WithDescription("List custom property values for organization repositories"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_list_custom_properties_values_for_reposHandler(cfg),
	}
}
