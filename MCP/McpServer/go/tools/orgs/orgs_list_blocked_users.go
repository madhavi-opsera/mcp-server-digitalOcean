...
func Orgs_list_blocked_usersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/blocks%s", cfg.BaseURL, org, queryString)
...
func CreateOrgs_list_blocked_usersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_blocks",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_list_blocked_usersHandler(cfg),
	}
}
