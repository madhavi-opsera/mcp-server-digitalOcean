...
func Orgs_list_outside_collaboratorsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/outside_collaborators%s", cfg.BaseURL, org, queryString)
...
func CreateOrgs_list_outside_collaboratorsTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_list_outside_collaboratorsHandler(cfg),
	}
}
