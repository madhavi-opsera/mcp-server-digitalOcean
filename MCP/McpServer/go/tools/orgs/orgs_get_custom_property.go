...
func Orgs_get_custom_propertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_get_custom_propertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_properties_schema_custom_property_name",
		mcp.WithDescription("Get a custom property for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_get_custom_propertyHandler(cfg),
	}
}
