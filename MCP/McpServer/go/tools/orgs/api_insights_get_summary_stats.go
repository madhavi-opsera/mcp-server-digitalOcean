...
func Api_insights_get_summary_statsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/insights/api/summary-stats%s", cfg.BaseURL, org, queryString)
...
func CreateApi_insights_get_summary_statsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_insights_api_summary-stats",
		mcp.WithDescription("Get summary stats"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Api_insights_get_summary_statsHandler(cfg),
	}
}
