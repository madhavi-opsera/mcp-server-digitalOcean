...
func Orgs_get_org_ruleset_historyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/rulesets/%s/history%s", cfg.BaseURL, org, ruleset_id, queryString)
...
func CreateOrgs_get_org_ruleset_historyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_rulesets_ruleset_id_history",
		mcp.WithDescription("Get organization ruleset history"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_get_org_ruleset_historyHandler(cfg),
	}
}
