...
func Orgs_list_pat_grant_request_repositoriesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/personal-access-token-requests/%s/repositories%s", cfg.BaseURL, org, pat_request_id, queryString)
...
func CreateOrgs_list_pat_grant_request_repositoriesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_personal-access-token-requests_pat_request_id",
		mcp.WithDescription("List repositories requested to be accessed by a fine-grained personal access token"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_list_pat_grant_request_repositoriesHandler(cfg),
	}
}
