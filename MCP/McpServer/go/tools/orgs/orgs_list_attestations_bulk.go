...
func Orgs_list_attestations_bulkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/attestations/bulk-list%s", cfg.BaseURL, org, queryString)
...
func CreateOrgs_list_attestations_bulkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_orgs_org_attestations_bulk-list",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_list_attestations_bulkHandler(cfg),
	}
}
