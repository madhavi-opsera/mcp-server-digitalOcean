...
func Orgs_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_deleteHandler(cfg),
	}
}
