...
func Apps_list_installation_requests_for_authenticated_appHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/app/installation-requests%s", cfg.BaseURL, queryString)
		...
		var result []models.GeneratedType_Integration_installation_request
...
func CreateApps_list_installation_requests_for_authenticated_appTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_app_installation-requests",
		mcp.WithDescription("List installation requests for the authenticated app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apps_list_installation_requests_for_authenticated_appHandler(cfg),
	}
}
