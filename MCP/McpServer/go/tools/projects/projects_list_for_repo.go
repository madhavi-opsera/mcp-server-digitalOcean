...
func Projects_list_for_repoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateProjects_list_for_repoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_projects",
		mcp.WithDescription("List repository projects"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Projects_list_for_repoHandler(cfg),
	}
}
