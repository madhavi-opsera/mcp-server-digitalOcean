...
func Projects_list_columnsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateProjects_list_columnsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_projects_project_id_columns",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Projects_list_columnsHandler(cfg),
	}
}
