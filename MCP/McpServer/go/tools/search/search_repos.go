...
func Search_reposHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/search/repositories%s", cfg.BaseURL, queryString)
...
func CreateSearch_reposTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_repositories",
		...
		mcp.WithString("sort", mcp.Description("Sorts the results of your query by number of `stars`, `forks`, or `help-wanted-issues` or how recently the items were `updated`. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Search_reposHandler(cfg),
	}
}
