...
func Pulls_list_reviewsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePulls_list_reviewsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_pulls_pull_number_reviews",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Pulls_list_reviewsHandler(cfg),
	}
}
