...
func Pulls_list_requested_reviewersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Pull_request_review_request
...
func CreatePulls_list_requested_reviewersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_pulls_pull_number_requested_reviewers",
		mcp.WithDescription("Get all requested reviewers for a pull request"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Pulls_list_requested_reviewersHandler(cfg),
	}
}
