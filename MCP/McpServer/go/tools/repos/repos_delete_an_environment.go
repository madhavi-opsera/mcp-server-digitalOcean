...
func Repos_delete_an_environmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_an_environmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_environments_environment_name_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_an_environmentHandler(cfg),
	}
}
