...
func Repos_get_pull_request_review_protectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_pull_request_review_protectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_branches_branch_protection_required_pull_request_reviews",
		mcp.WithDescription("Get pull request review protection"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_pull_request_review_protectionHandler(cfg),
	}
}
