...
func Repos_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_deleteHandler(cfg),
	}
}
