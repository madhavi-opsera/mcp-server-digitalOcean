...
func Repos_get_collaborator_permission_levelHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/collaborators/%s/permission", cfg.BaseURL, owner, repo, username)
		...
		var result models.GeneratedType_Repository_collaborator_permission
