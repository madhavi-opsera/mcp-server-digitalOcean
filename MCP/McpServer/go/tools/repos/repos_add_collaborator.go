...
func Repos_add_collaboratorHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/collaborators/%s", cfg.BaseURL, owner, repo, username)
...
func CreateRepos_add_collaboratorTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_collaborators_username",
		mcp.WithDescription("Add a repository collaborator"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_add_collaboratorHandler(cfg),
	}
}
