...
func Repos_compare_commitsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/compare/%s%s", cfg.BaseURL, owner, repo, basehead, queryString)
		...
		var result models.GeneratedType_Commit_comparison
...
func CreateRepos_compare_commitsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_compare_basehead",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_compare_commitsHandler(cfg),
	}
}
