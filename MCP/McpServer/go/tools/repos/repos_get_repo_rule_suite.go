...
func Repos_get_repo_rule_suiteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/rulesets/rule-suites/%s", cfg.BaseURL, owner, repo, rule_suite_id)
		...
		var result models.GeneratedType_Rule_suite
...
func CreateRepos_get_repo_rule_suiteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_rulesets_rule-suites_rule_suite_id",
		mcp.WithDescription("Get a repository rule suite"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_repo_rule_suiteHandler(cfg),
	}
}
