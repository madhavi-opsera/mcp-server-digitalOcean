...
func Repos_get_org_rulesetsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_org_rulesetsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_rulesets",
		mcp.WithDescription("Get all organization repository rulesets"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_org_rulesetsHandler(cfg),
	}
}
