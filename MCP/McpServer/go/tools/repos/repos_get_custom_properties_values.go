...
func Repos_get_custom_properties_valuesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result []models.GeneratedType_Custom_property_value
...
func CreateRepos_get_custom_properties_valuesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_properties_values",
		mcp.WithDescription("Get all custom property values for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_custom_properties_valuesHandler(cfg),
	}
}
