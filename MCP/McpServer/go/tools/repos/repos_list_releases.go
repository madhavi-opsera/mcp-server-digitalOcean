...
func Repos_list_releasesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_list_releasesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_releases",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_list_releasesHandler(cfg),
	}
}
