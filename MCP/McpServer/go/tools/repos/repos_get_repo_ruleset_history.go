...
func Repos_get_repo_ruleset_historyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/rulesets/%s/history%s", cfg.BaseURL, owner, repo, ruleset_id, queryString)
		...
		var result []models.GeneratedType_Ruleset_version
...
func CreateRepos_get_repo_ruleset_historyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_rulesets_ruleset_id_history",
		mcp.WithDescription("Get repository ruleset history"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_repo_ruleset_historyHandler(cfg),
	}
}
