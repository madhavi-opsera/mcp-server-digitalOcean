...
func Repos_list_autolinksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_list_autolinksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_autolinks",
		mcp.WithDescription("Get all autolinks of a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_list_autolinksHandler(cfg),
	}
}
