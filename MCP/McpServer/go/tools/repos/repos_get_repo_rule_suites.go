...
func Repos_get_repo_rule_suitesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/rulesets/rule-suites%s", cfg.BaseURL, owner, repo, queryString)
...
func CreateRepos_get_repo_rule_suitesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_rulesets_rule-suites",
		mcp.WithDescription("List repository rule suites"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_repo_rule_suitesHandler(cfg),
	}
}
