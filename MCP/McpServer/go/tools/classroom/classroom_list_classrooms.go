...
func Classroom_list_classroomsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/classrooms%s", cfg.BaseURL, queryString)
		...
		var result []models.GeneratedType_Simple_classroom
...
func CreateClassroom_list_classroomsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_classrooms",
		mcp.WithDescription("List classrooms"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Classroom_list_classroomsHandler(cfg),
	}
}
