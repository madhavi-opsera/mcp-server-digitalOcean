...
func Classroom_list_accepted_assignments_for_an_assignmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/assignments/%s/accepted_assignments%s", cfg.BaseURL, assignment_id, queryString)
...
func CreateClassroom_list_accepted_assignments_for_an_assignmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_assignments_assignment_id_accepted_assignments",
		mcp.WithDescription("List accepted assignments for an assignment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Classroom_list_accepted_assignments_for_an_assignmentHandler(cfg),
	}
}
