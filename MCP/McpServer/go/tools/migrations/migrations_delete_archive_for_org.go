...
func Migrations_delete_archive_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMigrations_delete_archive_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_migrations_migration_id_archive",
		mcp.WithDescription("Delete an organization migration archive"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Migrations_delete_archive_for_orgHandler(cfg),
	}
}
