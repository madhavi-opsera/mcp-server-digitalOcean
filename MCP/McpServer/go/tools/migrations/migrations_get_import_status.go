...
func Migrations_get_import_statusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMigrations_get_import_statusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_import",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Migrations_get_import_statusHandler(cfg),
	}
}
