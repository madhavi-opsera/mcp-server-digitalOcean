...
func Migrations_list_for_authenticated_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMigrations_list_for_authenticated_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_user_migrations",
		mcp.WithDescription("List user migrations"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Migrations_list_for_authenticated_userHandler(cfg),
	}
}
