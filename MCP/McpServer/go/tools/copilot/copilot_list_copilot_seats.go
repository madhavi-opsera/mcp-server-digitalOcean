...
func Copilot_list_copilot_seatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/copilot/billing/seats%s", cfg.BaseURL, org, queryString)
...
func CreateCopilot_list_copilot_seatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_copilot_billing_seats",
		mcp.WithDescription("List all Copilot seat assignments for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Copilot_list_copilot_seatsHandler(cfg),
	}
}
