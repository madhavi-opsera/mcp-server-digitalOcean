...
func Copilot_copilot_metrics_for_teamHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/team/%s/copilot/metrics%s", cfg.BaseURL, org, team_slug, queryString)
...
func CreateCopilot_copilot_metrics_for_teamTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_team_slug_copilot_metrics",
		mcp.WithDescription("Get Copilot metrics for a team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Copilot_copilot_metrics_for_teamHandler(cfg),
	}
}
