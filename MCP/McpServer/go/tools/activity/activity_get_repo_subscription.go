...
func Activity_get_repo_subscriptionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Repository_subscription
...
func CreateActivity_get_repo_subscriptionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_subscription",
		mcp.WithDescription("Get a repository subscription"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Activity_get_repo_subscriptionHandler(cfg),
	}
}
