...
func Issues_list_commentsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/issues/%s/comments%s", cfg.BaseURL, owner, repo, issue_number, queryString)
...
func CreateIssues_list_commentsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_issues_issue_number_comments",
		mcp.WithDescription("List issue comments"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_list_commentsHandler(cfg),
	}
}
