...
func Hosted_compute_get_network_settings_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		network_settings_idVal, ok := args["network_settings_id"]
		if !ok {
			return mcp.NewToolResultError("Missing required path parameter: network_settings_id"), nil
		}
		network_settings_id, ok := network_settings_idVal.(string)
		if !ok {
...
func CreateHosted_compute_get_network_settings_for_orgTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Hosted_compute_get_network_settings_for_orgHandler(cfg),
	}
}
