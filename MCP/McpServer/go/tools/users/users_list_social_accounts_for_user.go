...
func Users_list_social_accounts_for_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/%s/social_accounts%s", cfg.BaseURL, username, queryString)
...
func CreateUsers_list_social_accounts_for_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_username_social_accounts",
		mcp.WithDescription("List social accounts for a user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Users_list_social_accounts_for_userHandler(cfg),
	}
}
