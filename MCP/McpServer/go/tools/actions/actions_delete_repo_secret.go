...
func Actions_delete_repo_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_repo_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_actions_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_repo_secretHandler(cfg),
	}
}
