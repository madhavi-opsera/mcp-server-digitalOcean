...
func Actions_list_hosted_runners_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_list_hosted_runners_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_hosted-runners",
		mcp.WithDescription("List GitHub-hosted runners for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_hosted_runners_for_orgHandler(cfg),
	}
}
