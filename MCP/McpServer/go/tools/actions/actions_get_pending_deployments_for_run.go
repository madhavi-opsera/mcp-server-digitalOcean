...
func Actions_get_pending_deployments_for_runHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result []models.GeneratedType_Pending_deployment
...
func CreateActions_get_pending_deployments_for_runTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_runs_run_id_pending_deployments",
		mcp.WithDescription("Get pending deployments for a workflow run"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_pending_deployments_for_runHandler(cfg),
	}
}
