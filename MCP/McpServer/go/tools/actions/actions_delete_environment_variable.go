...
func Actions_delete_environment_variableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_environment_variableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_environments_environment_name_variables_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_environment_variableHandler(cfg),
	}
}
