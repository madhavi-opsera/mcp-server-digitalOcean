...
func Actions_get_org_variableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Organization_actions_variable
...
func CreateActions_get_org_variableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_variables_name",
		mcp.WithDescription("Get an organization variable"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_org_variableHandler(cfg),
	}
}
