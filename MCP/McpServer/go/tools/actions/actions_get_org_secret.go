...
func Actions_get_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Organization_actions_secret
...
func CreateActions_get_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_org_secretHandler(cfg),
	}
}
