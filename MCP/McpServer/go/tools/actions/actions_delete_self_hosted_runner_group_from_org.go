...
func Actions_delete_self_hosted_runner_group_from_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_self_hosted_runner_group_from_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_actions_runner-groups_runner_group_id_2",
		mcp.WithDescription("Delete a self-hosted runner group from an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_self_hosted_runner_group_from_orgHandler(cfg),
	}
}
