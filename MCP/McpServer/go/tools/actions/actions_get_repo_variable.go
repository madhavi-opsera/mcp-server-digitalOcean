...
func Actions_get_repo_variableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Actions_variable
...
func CreateActions_get_repo_variableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_variables_name",
		mcp.WithDescription("Get a repository variable"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_repo_variableHandler(cfg),
	}
}
