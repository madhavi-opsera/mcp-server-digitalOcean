...
func Actions_get_workflow_usageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/actions/workflows/%s/timing", cfg.BaseURL, owner, repo, workflow_id)
		...
		var result models.GeneratedType_Workflow_usage
...
func CreateActions_get_workflow_usageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_workflows_workflow_id_timing",
		mcp.WithDescription("Get workflow usage"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_workflow_usageHandler(cfg),
	}
}
