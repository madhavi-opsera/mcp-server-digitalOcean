...
func Actions_get_repo_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Actions_secret
...
func CreateActions_get_repo_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_repo_secretHandler(cfg),
	}
}
