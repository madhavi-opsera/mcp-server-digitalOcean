...
func Actions_get_workflow_access_to_repositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Actions_workflow_access_to_repository
...
func CreateActions_get_workflow_access_to_repositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_permissions_access",
		mcp.WithDescription("Get the level of access for workflows outside of the repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_workflow_access_to_repositoryHandler(cfg),
	}
}
