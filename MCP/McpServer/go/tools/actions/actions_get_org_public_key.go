...
func Actions_get_org_public_keyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/actions/secrets/public-key", cfg.BaseURL, org)
...
func CreateActions_get_org_public_keyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_secrets_public-key",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_org_public_keyHandler(cfg),
	}
}
