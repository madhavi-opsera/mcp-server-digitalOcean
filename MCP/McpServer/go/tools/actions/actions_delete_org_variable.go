...
func Actions_delete_org_variableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_org_variableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_actions_variables_name",
		mcp.WithDescription("Delete an organization variable"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_org_variableHandler(cfg),
	}
}
