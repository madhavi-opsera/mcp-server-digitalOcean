...
func Actions_get_github_actions_permissions_repositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Actions_repository_permissions
...
func CreateActions_get_github_actions_permissions_repositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_permissions",
		mcp.WithDescription("Get GitHub Actions permissions for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_github_actions_permissions_repositoryHandler(cfg),
	}
}
