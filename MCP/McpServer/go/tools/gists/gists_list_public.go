...
func Gists_list_publicHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/gists/public%s", cfg.BaseURL, queryString)
...
func CreateGists_list_publicTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_gists_public",
		mcp.WithDescription("List public gists"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Gists_list_publicHandler(cfg),
	}
}
