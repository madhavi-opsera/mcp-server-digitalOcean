...
func Gists_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGists_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_gists",
		mcp.WithDescription("List gists for the authenticated user"),
