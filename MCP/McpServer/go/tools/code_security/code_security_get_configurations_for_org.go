...
func Code_security_get_configurations_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["target_type"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("target_type=%v", val))
		}
...
func CreateCode_security_get_configurations_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_code-security_configurations",
		mcp.WithDescription("Get code security configurations for an organization"),
		mcp.WithString("org", mcp.Required(), mcp.Description("The organization name. The name is not case sensitive.")),
		mcp.WithString("target_type", mcp.Description("The target type of the code security configuration")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_get_configurations_for_orgHandler(cfg),
	}
}
