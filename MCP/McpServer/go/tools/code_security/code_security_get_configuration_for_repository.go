...
func Code_security_get_configuration_for_repositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/code-security-configuration", cfg.BaseURL, owner, repo)
		...
		var result models.GeneratedType_Code_security_configuration_for_repository
...
func CreateCode_security_get_configuration_for_repositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_code-security-configuration",
		mcp.WithDescription("Get the code security configuration associated with a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_get_configuration_for_repositoryHandler(cfg),
	}
}
