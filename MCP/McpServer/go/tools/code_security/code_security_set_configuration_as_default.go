...
func Code_security_set_configuration_as_defaultHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/code-security/configurations/%s/defaults", cfg.BaseURL, org, configuration_id)
...
func CreateCode_security_set_configuration_as_defaultTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_code-security_configurations_configuration_id",
