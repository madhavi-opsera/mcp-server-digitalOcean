...
func Teams_add_or_update_project_permissions_in_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTeams_add_or_update_project_permissions_in_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_teams_team_slug_projects_project_id",
		mcp.WithDescription("Add or update team project permissions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Teams_add_or_update_project_permissions_in_orgHandler(cfg),
	}
}
