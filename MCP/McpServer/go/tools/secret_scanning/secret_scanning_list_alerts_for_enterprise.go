...
func Secret_scanning_list_alerts_for_enterpriseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/enterprises/%s/secret-scanning/alerts%s", cfg.BaseURL, enterprise, queryString)
		...
		var result []models.GeneratedType_Organization_secret_scanning_alert
...
func CreateSecret_scanning_list_alerts_for_enterpriseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_enterprises_enterprise_secret-scanning_alerts",
		mcp.WithDescription("List secret scanning alerts for an enterprise"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Secret_scanning_list_alerts_for_enterpriseHandler(cfg),
	}
}
