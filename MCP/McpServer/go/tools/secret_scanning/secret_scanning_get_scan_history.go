...
func Secret_scanning_get_scan_historyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/secret-scanning/scan-history", cfg.BaseURL, owner, repo)
		...
		var result models.GeneratedType_Secret_scanning_scan_history
...
func CreateSecret_scanning_get_scan_historyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_secret-scanning_scan-history",
		mcp.WithDescription("Get secret scanning scan history for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Secret_scanning_get_scan_historyHandler(cfg),
	}
}
