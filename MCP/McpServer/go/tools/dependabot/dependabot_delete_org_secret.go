...
func Dependabot_delete_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDependabot_delete_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_dependabot_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_delete_org_secretHandler(cfg),
	}
}
