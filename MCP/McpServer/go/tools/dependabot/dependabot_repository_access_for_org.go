...
func Dependabot_repository_access_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/dependabot/repository-access%s", cfg.BaseURL, org, queryString)
		...
		var result models.GeneratedType_Dependabot_repository_access_details
...
func CreateDependabot_repository_access_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_org_dependabot_repository-access",
		mcp.WithDescription("Lists the repositories Dependabot can access in an organization"),
		...
		mcp.WithNumber("per_page", mcp.Description("Number of results per page.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_repository_access_for_orgHandler(cfg),
	}
}
