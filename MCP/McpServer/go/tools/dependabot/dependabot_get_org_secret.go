...
func Dependabot_get_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Organization_dependabot_secret
...
func CreateDependabot_get_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_dependabot_secrets_secret_name",
		mcp.WithDescription("Get an organization secret"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_get_org_secretHandler(cfg),
	}
}
