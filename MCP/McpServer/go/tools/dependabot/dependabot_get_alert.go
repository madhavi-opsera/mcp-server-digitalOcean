...
func Dependabot_get_alertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Dependabot_alert
...
func CreateDependabot_get_alertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_dependabot_alerts_alert_number",
		mcp.WithDescription("Get a Dependabot alert"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_get_alertHandler(cfg),
	}
}
