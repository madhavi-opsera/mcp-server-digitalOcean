...
func Dependabot_list_alerts_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/dependabot/alerts%s", cfg.BaseURL, org, queryString)
		...
		var result []models.GeneratedType_Dependabot_alert_with_repository
...
func CreateDependabot_list_alerts_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_dependabot_alerts",
		mcp.WithDescription("List Dependabot alerts for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_list_alerts_for_orgHandler(cfg),
	}
}
