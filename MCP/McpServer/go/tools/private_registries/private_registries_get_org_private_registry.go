...
func Private_registries_get_org_private_registryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Org_private_registry_configuration
...
func CreatePrivate_registries_get_org_private_registryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_private-registries_secret_name",
		mcp.WithDescription("Get a private registry for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Private_registries_get_org_private_registryHandler(cfg),
	}
}
