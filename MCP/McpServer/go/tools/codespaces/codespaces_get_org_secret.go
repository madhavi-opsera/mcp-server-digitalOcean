...
func Codespaces_get_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Codespaces_org_secret
...
func CreateCodespaces_get_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_codespaces_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_get_org_secretHandler(cfg),
	}
}
