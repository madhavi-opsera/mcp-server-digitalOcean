...
func Codespaces_add_repository_for_secret_for_authenticated_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodespaces_add_repository_for_secret_for_authenticated_userTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_add_repository_for_secret_for_authenticated_userHandler(cfg),
	}
}
