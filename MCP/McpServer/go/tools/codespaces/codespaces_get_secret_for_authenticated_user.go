...
func Codespaces_get_secret_for_authenticated_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Codespaces_secret
...
func CreateCodespaces_get_secret_for_authenticated_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_user_codespaces_secrets_secret_name",
		mcp.WithDescription("Get a secret for the authenticated user"),
		mcp.WithString("secret_name", mcp.Required(), mcp.Description("The name of the secret.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_get_secret_for_authenticated_userHandler(cfg),
	}
}
