...
func Codespaces_delete_repo_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodespaces_delete_repo_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_codespaces_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_delete_repo_secretHandler(cfg),
	}
}
