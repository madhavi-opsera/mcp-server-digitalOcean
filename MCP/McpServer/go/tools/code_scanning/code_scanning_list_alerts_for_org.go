...
func Code_scanning_list_alerts_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/code-scanning/alerts%s", cfg.BaseURL, org, queryString)
		...
		var result []models.GeneratedType_Code_scanning_organization_alert_items
...
func CreateCode_scanning_list_alerts_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_code-scanning_alerts",
		mcp.WithDescription("List code scanning alerts for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_scanning_list_alerts_for_orgHandler(cfg),
	}
}
