...
func Code_scanning_get_default_setupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GeneratedType_Code_scanning_default_setup
...
func CreateCode_scanning_get_default_setupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_code-scanning_default-setup",
		mcp.WithDescription("Get a code scanning default setup configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_scanning_get_default_setupHandler(cfg),
	}
}
