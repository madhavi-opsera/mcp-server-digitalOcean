...
func Checks_list_for_suiteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/check-suites/%s/check-runs%s", cfg.BaseURL, owner, repo, check_suite_id, queryString)
...
func CreateChecks_list_for_suiteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_check-suites_check_suite_id_check-runs",
		mcp.WithDescription("List check runs in a check suite"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Checks_list_for_suiteHandler(cfg),
	}
}
