...
func Issues_delete_milestoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateIssues_delete_milestoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_milestones_milestone_number",
		mcp.WithDescription("Delete a milestone"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_delete_milestoneHandler(cfg),
	}
}
