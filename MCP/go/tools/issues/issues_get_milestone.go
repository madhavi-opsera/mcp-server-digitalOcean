...
func Issues_get_milestoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateIssues_get_milestoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_milestones_milestone_number",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_get_milestoneHandler(cfg),
	}
}
