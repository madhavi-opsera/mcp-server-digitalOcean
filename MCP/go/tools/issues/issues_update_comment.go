...
func Issues_update_commentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateIssues_update_commentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_repos_owner_repo_issues_comments_comment_id",
		mcp.WithDescription("Update an issue comment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_update_commentHandler(cfg),
	}
}
