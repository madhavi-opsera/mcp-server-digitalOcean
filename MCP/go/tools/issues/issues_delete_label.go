...
func Issues_delete_labelHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateIssues_delete_labelTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_labels_name",
		mcp.WithDescription("Delete a label"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_delete_labelHandler(cfg),
	}
}
