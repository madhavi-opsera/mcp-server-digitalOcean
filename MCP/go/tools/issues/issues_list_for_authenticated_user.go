...
func Issues_list_for_authenticated_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/user/issues%s", cfg.BaseURL, queryString)
...
func CreateIssues_list_for_authenticated_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_user_issues",
		mcp.WithDescription("List user account issues assigned to the authenticated user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_list_for_authenticated_userHandler(cfg),
	}
}
