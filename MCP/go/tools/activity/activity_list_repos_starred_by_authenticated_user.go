...
func Activity_list_repos_starred_by_authenticated_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/user/starred%s", cfg.BaseURL, queryString)
...
func CreateActivity_list_repos_starred_by_authenticated_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_user_starred",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Activity_list_repos_starred_by_authenticated_userHandler(cfg),
	}
}
