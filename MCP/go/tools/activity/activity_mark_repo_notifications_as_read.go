...
func Activity_mark_repo_notifications_as_readHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActivity_mark_repo_notifications_as_readTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_notifications",
		mcp.WithDescription("Mark repository notifications as read"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Activity_mark_repo_notifications_as_readHandler(cfg),
	}
}
