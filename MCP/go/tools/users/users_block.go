...
func Users_blockHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsers_blockTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_user_blocks_username",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Users_blockHandler(cfg),
	}
}
