...
func Users_list_attestationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/%s/attestations/%s%s", cfg.BaseURL, username, subject_digest, queryString)
...
func CreateUsers_list_attestationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_username_attestations_subject_digest",
		...
		mcp.WithString("subject_digest", mcp.Required(), mcp.Description("Subject Digest")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Users_list_attestationsHandler(cfg),
	}
}
