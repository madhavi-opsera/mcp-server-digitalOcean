...
func Users_unfollowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsers_unfollowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_user_following_username",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Users_unfollowHandler(cfg),
	}
}
