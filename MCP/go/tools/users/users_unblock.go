...
func Users_unblockHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsers_unblockTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_user_blocks_username",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Users_unblockHandler(cfg),
	}
}
