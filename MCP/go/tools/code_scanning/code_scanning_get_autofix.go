...
func Code_scanning_get_autofixHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/code-scanning/alerts/%s/autofix%s", cfg.BaseURL, owner, repo, alert_number, queryString)
...
func CreateCode_scanning_get_autofixTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_code-scanning_alerts_alert_number_autofix",
		mcp.WithDescription("Get the status of an autofix for a code scanning alert"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_scanning_get_autofixHandler(cfg),
	}
}
