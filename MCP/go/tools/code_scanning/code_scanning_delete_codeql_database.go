...
func Code_scanning_delete_codeql_databaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCode_scanning_delete_codeql_databaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_code-scanning_codeql_databases_language",
		mcp.WithDescription("Delete a CodeQL database"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_scanning_delete_codeql_databaseHandler(cfg),
	}
}
