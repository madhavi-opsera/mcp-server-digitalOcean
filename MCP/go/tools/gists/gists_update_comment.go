...
func Gists_update_commentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/gists/%s/comments/%s%s", cfg.BaseURL, gist_id, comment_id, queryString)
...
func CreateGists_update_commentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_gists_gist_id_comments_comment_id",
		mcp.WithDescription("Update a gist comment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Gists_update_commentHandler(cfg),
	}
}
