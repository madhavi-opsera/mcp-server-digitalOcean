...
func Gists_get_commentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGists_get_commentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_gists_gist_id_comments_comment_id",
		mcp.WithDescription("Get a gist comment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Gists_get_commentHandler(cfg),
	}
}
