...
func Repos_get_all_deployment_protection_rulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_all_deployment_protection_rulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_environments_environment_name_deployment_protection_rules",
		mcp.WithDescription("Get all deployment protection rules for an environment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_all_deployment_protection_rulesHandler(cfg),
	}
}
