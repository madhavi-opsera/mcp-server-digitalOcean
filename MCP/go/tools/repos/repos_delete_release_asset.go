...
func Repos_delete_release_assetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_release_assetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_releases_assets_asset_id",
		mcp.WithDescription("Delete a release asset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_release_assetHandler(cfg),
	}
}
