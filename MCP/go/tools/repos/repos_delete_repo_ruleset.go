...
func Repos_delete_repo_rulesetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_repo_rulesetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_rulesets_ruleset_id",
		mcp.WithDescription("Delete a repository ruleset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_repo_rulesetHandler(cfg),
	}
}
