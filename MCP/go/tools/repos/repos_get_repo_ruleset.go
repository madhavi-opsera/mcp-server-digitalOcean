...
func Repos_get_repo_rulesetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_repo_rulesetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_rulesets_ruleset_id",
		mcp.WithDescription("Get a repository ruleset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_repo_rulesetHandler(cfg),
	}
}
