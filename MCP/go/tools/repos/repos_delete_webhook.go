...
func Repos_delete_webhookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_webhookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_hooks_hook_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_webhookHandler(cfg),
	}
}
