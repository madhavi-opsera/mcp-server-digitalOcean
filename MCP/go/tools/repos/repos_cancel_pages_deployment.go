...
func Repos_cancel_pages_deploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/pages/deployments/%s/cancel%s", cfg.BaseURL, owner, repo, pages_deployment_id, queryString)
...
func CreateRepos_cancel_pages_deploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repos_owner_repo_pages_deployments_pages_deployment_id_cancel",
		mcp.WithDescription("Cancel a GitHub Pages deployment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_cancel_pages_deploymentHandler(cfg),
	}
}
