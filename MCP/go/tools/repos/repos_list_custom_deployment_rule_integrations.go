...
func Repos_list_custom_deployment_rule_integrationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/environments/%s/deployment_protection_rules/apps%s", cfg.BaseURL, environment_name, repo, owner, queryString)
...
func CreateRepos_list_custom_deployment_rule_integrationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_environments_environment_name_deployment_protection_rules_apps",
		mcp.WithDescription("List custom deployment rule integrations available for an environment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_list_custom_deployment_rule_integrationsHandler(cfg),
	}
}
