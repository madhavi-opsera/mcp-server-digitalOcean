...
func Repos_delete_admin_branch_protectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_admin_branch_protectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_branches_branch_protection_enforce_admins",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_admin_branch_protectionHandler(cfg),
	}
}
