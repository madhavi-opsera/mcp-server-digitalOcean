...
func Repos_get_code_frequency_statsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/stats/code_frequency%s", cfg.BaseURL, owner, repo, queryString)
...
func CreateRepos_get_code_frequency_statsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_stats_code_frequency",
		mcp.WithDescription("Get the weekly commit activity"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_code_frequency_statsHandler(cfg),
	}
}
