...
func Repos_update_commit_commentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_update_commit_commentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_repos_owner_repo_comments_comment_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_update_commit_commentHandler(cfg),
	}
}
