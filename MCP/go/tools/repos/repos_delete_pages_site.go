...
func Repos_delete_pages_siteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_pages_siteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_pages",
		mcp.WithDescription("Delete a GitHub Pages site"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_pages_siteHandler(cfg),
	}
}
