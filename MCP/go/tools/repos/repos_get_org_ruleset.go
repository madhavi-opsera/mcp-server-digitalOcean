...
func Repos_get_org_rulesetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_org_rulesetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_rulesets_ruleset_id",
		mcp.WithDescription("Get an organization repository ruleset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_org_rulesetHandler(cfg),
	}
}
