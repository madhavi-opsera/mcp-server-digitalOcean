...
func Repos_set_user_access_restrictionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_set_user_access_restrictionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_branches_branch_protection_restrictions_users",
		mcp.WithDescription("Set user access restrictions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_set_user_access_restrictionsHandler(cfg),
	}
}
