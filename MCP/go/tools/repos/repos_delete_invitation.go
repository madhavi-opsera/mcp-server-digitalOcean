...
func Repos_delete_invitationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_delete_invitationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_invitations_invitation_id",
		mcp.WithDescription("Delete a repository invitation"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_delete_invitationHandler(cfg),
	}
}
