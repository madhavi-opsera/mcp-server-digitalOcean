...
func Repos_get_autolinkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_autolinkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_autolinks_autolink_id",
		mcp.WithDescription("Get an autolink reference of a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_autolinkHandler(cfg),
	}
}
