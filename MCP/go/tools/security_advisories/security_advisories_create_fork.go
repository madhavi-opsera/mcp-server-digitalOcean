...
func Security_advisories_create_forkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/security-advisories/%s/forks%s", cfg.BaseURL, owner, repo, ghsa_id, queryString)
...
func CreateSecurity_advisories_create_forkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repos_owner_repo_security-advisories_ghsa_id_forks",
		mcp.WithDescription("Create a temporary private fork"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Security_advisories_create_forkHandler(cfg),
	}
}
