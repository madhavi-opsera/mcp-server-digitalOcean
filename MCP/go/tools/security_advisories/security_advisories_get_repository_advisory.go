...
func Security_advisories_get_repository_advisoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateSecurity_advisories_get_repository_advisoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_security-advisories_ghsa_id",
		mcp.WithDescription("Get a repository security advisory"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Security_advisories_get_repository_advisoryHandler(cfg),
	}
}
