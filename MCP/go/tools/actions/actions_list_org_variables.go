...
func Actions_list_org_variablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_list_org_variablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_variables",
		mcp.WithDescription("List organization variables"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_org_variablesHandler(cfg),
	}
}
