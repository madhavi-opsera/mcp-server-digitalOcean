...
func Actions_get_github_actions_default_workflow_permissions_repositoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/actions/permissions/workflow%s", cfg.BaseURL, owner, repo, queryString)
...
func CreateActions_get_github_actions_default_workflow_permissions_repositoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_permissions_workflow",
		mcp.WithDescription("Get default workflow permissions for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_github_actions_default_workflow_permissions_repositoryHandler(cfg),
	}
}
