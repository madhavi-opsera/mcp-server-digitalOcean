...
func Actions_remove_repo_access_to_self_hosted_runner_group_in_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/actions/runner-groups/%s/repositories/%s%s", cfg.BaseURL, org, runner_group_id, repository_id, queryString)
...
func CreateActions_remove_repo_access_to_self_hosted_runner_group_in_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_actions_runner-groups_runner_group_id_repositories_repository_id",
		mcp.WithDescription("Remove repository access to a self-hosted runner group in an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_remove_repo_access_to_self_hosted_runner_group_in_orgHandler(cfg),
	}
}
