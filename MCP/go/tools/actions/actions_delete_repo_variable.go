...
func Actions_delete_repo_variableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_repo_variableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_actions_variables_name",
		mcp.WithDescription("Delete a repository variable"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_repo_variableHandler(cfg),
	}
}
