...
func Actions_list_self_hosted_runners_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/actions/runners%s", cfg.BaseURL, org, queryString)
...
func CreateActions_list_self_hosted_runners_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_runners",
		mcp.WithDescription("List self-hosted runners for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_self_hosted_runners_for_orgHandler(cfg),
	}
}
