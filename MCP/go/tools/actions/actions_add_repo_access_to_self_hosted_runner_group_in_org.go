...
func Actions_add_repo_access_to_self_hosted_runner_group_in_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_add_repo_access_to_self_hosted_runner_group_in_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_actions_runner-groups_runner_group_id_repositories_repository_id",
		mcp.WithDescription("Add repository access to a self-hosted runner group in an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_add_repo_access_to_self_hosted_runner_group_in_orgHandler(cfg),
	}
}
