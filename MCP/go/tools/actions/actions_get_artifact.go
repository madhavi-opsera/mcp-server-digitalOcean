...
func Actions_get_artifactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_get_artifactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_actions_artifacts_artifact_id",
		mcp.WithDescription("Get an artifact"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_artifactHandler(cfg),
	}
}
