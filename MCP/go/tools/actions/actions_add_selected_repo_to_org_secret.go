...
func Actions_add_selected_repo_to_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_add_selected_repo_to_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_actions_secrets_secret_name_repositories_repository_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_add_selected_repo_to_org_secretHandler(cfg),
	}
}
