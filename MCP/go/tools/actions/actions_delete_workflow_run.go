...
func Actions_delete_workflow_runHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_workflow_runTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_actions_runs_run_id",
		mcp.WithDescription("Delete a workflow run"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_workflow_runHandler(cfg),
	}
}
