...
func Actions_list_org_secretsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/actions/secrets%s", cfg.BaseURL, org, queryString)
...
func CreateActions_list_org_secretsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_secrets",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_org_secretsHandler(cfg),
	}
}
