...
func Actions_delete_artifactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/actions/artifacts/%s%s", cfg.BaseURL, owner, repo, artifact_id, queryString)
...
func CreateActions_delete_artifactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_repos_owner_repo_actions_artifacts_artifact_id",
		mcp.WithDescription("Delete an artifact"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_artifactHandler(cfg),
	}
}
