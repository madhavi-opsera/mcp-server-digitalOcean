...
func Actions_list_repo_access_to_self_hosted_runner_group_in_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_list_repo_access_to_self_hosted_runner_group_in_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_runner-groups_runner_group_id_repositories",
		mcp.WithDescription("List repository access to a self-hosted runner group in an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_repo_access_to_self_hosted_runner_group_in_orgHandler(cfg),
	}
}
