...
func Actions_delete_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_delete_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_actions_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_delete_org_secretHandler(cfg),
	}
}
