...
func Teams_delete_discussion_in_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTeams_delete_discussion_in_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_teams_team_slug_discussions_discussion_number",
		mcp.WithDescription("Delete a discussion"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Teams_delete_discussion_in_orgHandler(cfg),
	}
}
