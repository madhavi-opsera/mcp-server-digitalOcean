...
func Teams_add_or_update_project_permissions_legacyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/teams/%s/projects/%s%s", cfg.BaseURL, team_id, project_id, queryString)
...
func CreateTeams_add_or_update_project_permissions_legacyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_teams_team_id_projects_project_id",
		mcp.WithDescription("Add or update team project permissions (Legacy)"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Teams_add_or_update_project_permissions_legacyHandler(cfg),
	}
}
