...
func Hosted_compute_list_network_configurations_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/settings/network-configurations%s", cfg.BaseURL, org, queryString)
...
func CreateHosted_compute_list_network_configurations_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_settings_network-configurations",
		mcp.WithDescription("List hosted compute network configurations for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Hosted_compute_list_network_configurations_for_orgHandler(cfg),
	}
}
