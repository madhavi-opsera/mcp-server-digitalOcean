...
func Private_registries_delete_org_private_registryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePrivate_registries_delete_org_private_registryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_private-registries_secret_name",
		mcp.WithDescription("Delete a private registry for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Private_registries_delete_org_private_registryHandler(cfg),
	}
}
