...
func Orgs_revoke_all_org_roles_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/organization-roles/users/%s%s", cfg.BaseURL, org, username, queryString)
...
func CreateOrgs_revoke_all_org_roles_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_organization-roles_users_username",
		mcp.WithDescription("Remove all organization roles for a user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_revoke_all_org_roles_userHandler(cfg),
	}
}
