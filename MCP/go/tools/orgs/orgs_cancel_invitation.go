...
func Orgs_cancel_invitationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/invitations/%s%s", cfg.BaseURL, org, invitation_id, queryString)
...
func CreateOrgs_cancel_invitationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_invitations_invitation_id",
		mcp.WithDescription("Cancel an organization invitation"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_cancel_invitationHandler(cfg),
	}
}
