...
func Orgs_revoke_org_role_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/organization-roles/users/%s/%s%s", cfg.BaseURL, org, username, role_id, queryString)
...
func CreateOrgs_revoke_org_role_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_organization-roles_users_username_role_id",
		mcp.WithDescription("Remove an organization role from a user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_revoke_org_role_userHandler(cfg),
	}
}
