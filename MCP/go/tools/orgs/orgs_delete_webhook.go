...
func Orgs_delete_webhookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_delete_webhookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_hooks_hook_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_delete_webhookHandler(cfg),
	}
}
