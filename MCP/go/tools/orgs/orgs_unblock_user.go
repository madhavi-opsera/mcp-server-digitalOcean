...
func Orgs_unblock_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_unblock_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_blocks_username",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_unblock_userHandler(cfg),
	}
}
