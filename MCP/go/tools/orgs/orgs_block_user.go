...
func Orgs_block_userHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_block_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_blocks_username",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_block_userHandler(cfg),
	}
}
