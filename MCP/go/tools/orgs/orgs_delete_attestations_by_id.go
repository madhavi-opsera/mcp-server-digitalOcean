...
func Orgs_delete_attestations_by_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/attestations/%s%s", cfg.BaseURL, org, attestation_id, queryString)
...
func CreateOrgs_delete_attestations_by_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_attestations_attestation_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_delete_attestations_by_idHandler(cfg),
	}
}
