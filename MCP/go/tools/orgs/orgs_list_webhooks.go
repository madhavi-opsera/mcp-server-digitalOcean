...
func Orgs_list_webhooksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrgs_list_webhooksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_hooks",
		mcp.WithDescription("List organization webhooks"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_list_webhooksHandler(cfg),
	}
}
