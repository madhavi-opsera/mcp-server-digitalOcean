...
func Orgs_revoke_all_org_roles_teamHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/organization-roles/teams/%s%s", cfg.BaseURL, org, team_slug, queryString)
...
func CreateOrgs_revoke_all_org_roles_teamTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_organization-roles_teams_team_slug",
		mcp.WithDescription("Remove all organization roles for a team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Orgs_revoke_all_org_roles_teamHandler(cfg),
	}
}
