...
func Codespaces_delete_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodespaces_delete_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_codespaces_secrets_secret_name",
		mcp.WithDescription("Delete an organization secret"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_delete_org_secretHandler(cfg),
	}
}
