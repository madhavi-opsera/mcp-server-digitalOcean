...
func Codespaces_list_org_secretsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/codespaces/secrets%s", cfg.BaseURL, org, queryString)
...
func CreateCodespaces_list_org_secretsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_codespaces_secrets",
		mcp.WithDescription("List organization secrets"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_list_org_secretsHandler(cfg),
	}
}
