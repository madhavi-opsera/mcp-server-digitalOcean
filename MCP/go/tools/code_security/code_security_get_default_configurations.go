...
func Code_security_get_default_configurationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/code-security/configurations/defaults%s", cfg.BaseURL, org, queryString)
...
func CreateCode_security_get_default_configurationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_code-security_configurations_defaults",
		mcp.WithDescription("Get default code security configurations"),
		mcp.WithString("org", mcp.Required(), mcp.Description("The organization name. The name is not case sensitive.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Code_security_get_default_configurationsHandler(cfg),
	}
}
