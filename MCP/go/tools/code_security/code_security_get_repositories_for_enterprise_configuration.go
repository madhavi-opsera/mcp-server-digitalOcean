...
func Code_security_get_repositories_for_enterprise_configurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/enterprises/%s/code-security/configurations/%s/repositories%s", cfg.BaseURL, enterprise, configuration_id, queryString)
...
func CreateCode_security_get_repositories_for_enterprise_configurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_enterprises_enterprise_code-security_configurations_configuration_id_repositories",
		mcp.WithDescription("Get repositories associated with an enterprise code security configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_get_repositories_for_enterprise_configurationHandler(cfg),
	}
}
