...
func Code_security_get_single_configuration_for_enterpriseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCode_security_get_single_configuration_for_enterpriseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_enterprises_enterprise_code-security_configurations_configuration_id",
		mcp.WithDescription("Retrieve a code security configuration of an enterprise"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_get_single_configuration_for_enterpriseHandler(cfg),
	}
}
