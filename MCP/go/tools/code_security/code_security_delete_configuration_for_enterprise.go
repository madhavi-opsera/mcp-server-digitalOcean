...
func Code_security_delete_configuration_for_enterpriseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCode_security_delete_configuration_for_enterpriseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_enterprises_enterprise_code-security_configurations_configuration_id",
		mcp.WithDescription("Delete a code security configuration for an enterprise"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_delete_configuration_for_enterpriseHandler(cfg),
	}
}
