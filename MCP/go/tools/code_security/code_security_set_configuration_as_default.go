...
func Code_security_set_configuration_as_defaultHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/code-security/configurations/%s/defaults%s", cfg.BaseURL, org, configuration_id, queryString)
...
func CreateCode_security_set_configuration_as_defaultTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_code-security_configurations_configuration_id_defaults",
		mcp.WithDescription("Set a code security configuration as a default for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_set_configuration_as_defaultHandler(cfg),
	}
}
