...
func Code_security_set_configuration_as_default_for_enterpriseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/enterprises/%s/code-security/configurations/%s/defaults%s", cfg.BaseURL, enterprise, configuration_id, queryString)
...
func CreateCode_security_set_configuration_as_default_for_enterpriseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_enterprises_enterprise_code-security_configurations_configuration_id_defaults",
		mcp.WithDescription("Set a code security configuration as a default for an enterprise"),
		...
		mcp.WithString("default_for_new_repos", mcp.Description("Input parameter: Specify which types of repository this security configuration should be applied to by default.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Code_security_set_configuration_as_default_for_enterpriseHandler(cfg),
	}
}
