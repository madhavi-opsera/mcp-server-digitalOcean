...
func Dependabot_add_selected_repo_to_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDependabot_add_selected_repo_to_org_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_dependabot_secrets_secret_name_repositories_repository_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_add_selected_repo_to_org_secretHandler(cfg),
	}
}
