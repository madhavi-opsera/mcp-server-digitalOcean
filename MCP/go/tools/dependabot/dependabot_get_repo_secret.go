...
func Dependabot_get_repo_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDependabot_get_repo_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_dependabot_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_get_repo_secretHandler(cfg),
	}
}
