...
func Campaigns_get_campaign_summaryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCampaigns_get_campaign_summaryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_campaigns_campaign_number",
		mcp.WithDescription("Get a campaign for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Campaigns_get_campaign_summaryHandler(cfg),
	}
}
