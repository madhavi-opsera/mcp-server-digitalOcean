...
func Projects_create_for_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateProjects_create_for_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_orgs_org_projects",
		mcp.WithDescription("Create an organization project"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Projects_create_for_orgHandler(cfg),
	}
}
