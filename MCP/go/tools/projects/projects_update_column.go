...
func Projects_update_columnHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/projects/columns/%s%s", cfg.BaseURL, column_id, queryString)
...
func CreateProjects_update_columnTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_projects_columns_column_id",
		mcp.WithDescription("Update an existing project column"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Projects_update_columnHandler(cfg),
	}
}
